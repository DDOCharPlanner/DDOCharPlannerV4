...
enum WINDOWID {MS_NAMELABEL, MS_RACECLASSLABEL,
			   ...
			   FE_FORUMBACKGROUNDLABEL, FE_FORUMBACKGROUNDDARKRADIOBUTTON, FE_FORUMBACKGROUNDLIGHTRADIOBUTTON, FE_TEMPLATESELECTLABEL, FE_TEMPLATESELECT, FE_TEMPLATEDESIGNBUTTON, 
				...
				MAB_L4, MAB_L8, MAB_L12, MAB_L16, MAB_L20, MAB_L24, MAB_L28, MAB_LTOTAL, MAB_CURRENTLABEL, MAB_VALUE, MAB_MOD, MAB_TOMESLABEL, MAB_T1, MAB_T2, MAB_T3, MAB_T4,
				MAB_T5, MAB_T6, MAB_T7, MAB_PASTLABEL, MAB_TOMESTOTAL, MAB_STRTOT, MAB_DEXTOT, MAB_CONTOT, MAB_INTTOT, MAB_WISTOT, MAB_CHATOT,
