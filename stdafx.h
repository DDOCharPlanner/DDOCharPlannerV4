...
enum WINDOWID {MS_NAMELABEL, MS_RACECLASSLABEL,
			   ...
			   FE_FORUMBACKGROUNDLABEL, FE_FORUMBACKGROUNDDARKRADIOBUTTON, FE_FORUMBACKGROUNDLIGHTRADIOBUTTON, FE_TEMPLATESELECTLABEL, FE_TEMPLATESELECT, FE_TEMPLATEDESIGNBUTTON, 
				...
				EW_ACCEPTBUTTON, EW_CANCELBUTTON, EW_RESPEC, EW_RESETALLTREESBUTTON, EW_APREMAININGLABEL, EW_APSPENTLABEL, EW_TREEFRAME1, EW_TREEFRAME2, EW_TREEFRAME3, EW_SELECTTREELIST, EW_APTOME,
				...
				MAB_T5, MAB_T6, MAB_T7, MAB_T8, MAB_TOMETOTAL, MAB_INSFRAME, MAB_INSLABEL, MAB_INSBOX,
