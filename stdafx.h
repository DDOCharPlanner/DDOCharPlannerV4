...
#define NUM_ENHANCEMENT_TREES 62
#define NUM_DESTINY_TREES 13
#define PASTLIFEFEAT 14
#define EPICPASTLIFESPHERE 4
#define ICONICPASTLIFEFEAT 5
#define RACEPASTLIFE 10
#define _WINNT_WIN32 0600

enum WINDOWID {MS_NAMELABEL, MS_RACECLASSLABEL,
               MS_LOADBUTTON, MS_SAVEBUTTON, MS_SAVEASBUTTON, MS_CLEARBUTTON, MS_PRINTBUTTON, MS_FORUMEXPORTBUTTON, MS_ABOUTBUTTON, MS_QUITBUTTON, MS_EQUIPMENTSCREENBUTTON, MS_ITEMBUILDERBUTTON, MS_DISPLAYERRORBUTTON,
...
enum RACE {HUMAN, ELF, HALFLING, DWARF, WARFORGED, DROW, HALFELF, HALFORC, BLADEFORGED, MORNINGLORD, PURPLEDRAGONKNIGHT, SHADARKAI, GNOME, DEEPGNOME, DRAGONBORN, RACENONE};
...
enum FEATSLOTTYPE { FEATAUTOMATIC, FEATCHARACTER, FEATHUMANBONUS, FEATFIGHTERBONUS, FEATWIZARDBONUS, FEATRANGERFAVOREDENEMY, FEATROGUEBONUS, FEATMONKBONUS, FEATMONKPATH, FEATDEITY, FEATFAVOREDSOULBONUS,
	FEATPASTLIFE, FEATNONE, FEATSELECTED, FEATDERIVED, FEATHALFELFBONUS, FEATARTIFICERBONUS, FEATDRUIDWILDSHAPE, FEATDESTINY, FEATWARLOCKPACT, FEATLEGENDARY, FEATDRAGONBORNBONUS};
...
enum FEATTAG {FEATTAGMETAMAGIC, FEATTAGFIGHTERBONUS, FEATTAGFAVOREDENEMY, FEATTAGROGUEBONUS, FEATTAGMONKBONUS, FEATTAGMONKPATH, FEATTAGDEITY, FEATTAGFAVOREDSOULBONUS, FEATTAGMULTIPLE, FEATTAGPARENTFEAT,
	FEATTAGPASTLIFE, FEATTAGHALFELFBONUS, FEATTAGMONKEXCLUSIVE, FEATTAGARTIFICERBONUS, FEATTAGDRUIDWILDSHAPE, FEATTAGDESTINY, FEATTAGDESTINYNOTEXCLUSIVE, FEATTAGWARLOCKPACT, FEATTAGLEGENDARY, FEATTAGDRAGONBORNBONUS, FEATTAGNONE}; //Level Cap Increase
...
enum ENHANCEMENT_TREE {ENHT_BLADEFORGED, ENHT_DROW, ENHT_DWARF, ENHT_ELF, ENHT_HALFLING, ENHT_HALF_ELF,
						...
						ENHT_SOULEATER_WLK, ENHT_TANTEDSCHOLAR_WLK, ENHT_ENLIGHTENEDSPIRIT_WLK, ENHT_GNOME, ENHT_DEEPGNOME, ENHT_DRAGONBORN,
...
enum PAST_RACE { FEAT_HUMAN, FEAT_ELF, FEAT_HALFLING, FEAT_DWARF, FEAT_WARFORGED, FEAT_DROW, FEAT_HALFELF, FEAT_HALFORC, FEAT_GNOME, FEAT_DRAGONBORN, FEAT_RACENONE };
