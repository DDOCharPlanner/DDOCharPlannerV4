...
enum RACE {HUMAN, ELF, HALFLING, DWARF, WARFORGED, DROW, HALFELF, HALFORC, BLADEFORGED, MORNINGLORD, PURPLEDRAGONKNIGHT, SHADARKAI, GNOME, DEEPGNOME, DRAGONBORN, AASIMAR, AASIMARSCOURGE, RACENONE};
...
enum ENHANCEMENT_TREE {ENHT_BLADEFORGED, ENHT_DROW, ENHT_DWARF, ENHT_ELF, ENHT_HALFLING, ENHT_HALF_ELF,
						...
						ENHT_SOULEATER_WLK, ENHT_TANTEDSCHOLAR_WLK, ENHT_ENLIGHTENEDSPIRIT_WLK, ENHT_GNOME, ENHT_DEEPGNOME, ENHT_DRAGONBORN, ENHT_AASIMAR, ENHT_VISTANIKNIFEFIGHTER, ENHT_AASIMARSCOURGE,
...
enum ICONICRACES{FEAT_BLADEFORGED, FEAT_MORNINGLORD, FEAT_PURPLEDRAGONKNIGHT, FEAT_SHADARKAI, FEAT_DEEPGNOME, FEAT_AASIMARSCOURGE};
