...
#define NUM_ENHANCEMENT_TREES 64
...
enum RACE {HUMAN, ELF, HALFLING, DWARF, WARFORGED, DROW, HALFELF, HALFORC, BLADEFORGED, MORNINGLORD, PURPLEDRAGONKNIGHT, SHADARKAI, GNOME, DEEPGNOME, DRAGONBORN, AASIMAR, RACENONE};
...
enum FEATSLOTTYPE { FEATAUTOMATIC, FEATCHARACTER, FEATHUMANBONUS, FEATFIGHTERBONUS, FEATWIZARDBONUS, FEATRANGERFAVOREDENEMY, FEATROGUEBONUS, FEATMONKBONUS, FEATMONKPATH, FEATDEITY, FEATFAVOREDSOULBONUS,
	FEATPASTLIFE, FEATNONE, FEATSELECTED, FEATDERIVED, FEATHALFELFBONUS, FEATARTIFICERBONUS, FEATDRUIDWILDSHAPE, FEATDESTINY, FEATWARLOCKPACT, FEATLEGENDARY, FEATDRAGONBORNBONUS, FEATCLERICBONUS};
...
enum FEATTAG {FEATTAGMETAMAGIC, FEATTAGFIGHTERBONUS, FEATTAGFAVOREDENEMY, FEATTAGROGUEBONUS, FEATTAGMONKBONUS, FEATTAGMONKPATH, FEATTAGDEITY, FEATTAGFAVOREDSOULBONUS, FEATTAGMULTIPLE, FEATTAGPARENTFEAT,
	FEATTAGPASTLIFE, FEATTAGHALFELFBONUS, FEATTAGMONKEXCLUSIVE, FEATTAGARTIFICERBONUS, FEATTAGDRUIDWILDSHAPE, FEATTAGDESTINY, FEATTAGDESTINYNOTEXCLUSIVE, FEATTAGWARLOCKPACT, FEATTAGLEGENDARY, FEATTAGDRAGONBORNBONUS, FEATTAGCLERICBONUS, FEATTAGNONE}; //Level Cap Increase
...
enum ENHANCEMENT_TREE {ENHT_BLADEFORGED, ENHT_DROW, ENHT_DWARF, ENHT_ELF, ENHT_HALFLING, ENHT_HALF_ELF,
						...
						ENHT_SOULEATER_WLK, ENHT_TANTEDSCHOLAR_WLK, ENHT_ENLIGHTENEDSPIRIT_WLK, ENHT_GNOME, ENHT_DEEPGNOME, ENHT_DRAGONBORN, ENHT_AASIMAR, ENHT_VISTANIKNIFEFIGHTER,
